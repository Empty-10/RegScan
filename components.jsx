// RegScan — shared components (header, footer, icons, etc.)
// Exposed on window so other JSX files can use them.
  ...
  return (
    <header className="site-header">
      <div className="container">
        <div className="row">
          <a href="index.html" className="brand" aria-label="RegScan home">
            <span className="brand-mark">R</span>
            <span>RegScan</span>
          </a>
          <nav className="nav" aria-label="Primary">
            <a href="index.html#how" className={"nav-link" + (active === "how" ? " active" : "")}>How it works</a>
            <a href="index.html#reminders" className={"nav-link" + (active === "reminders" ? " active" : "")}>Reminders</a>
            <a href="garage.html" className={"nav-link" + (active === "garage" ? " active" : "")}>My Garage</a>
            <a href="index.html#faq" className={"nav-link" + (active === "faq" ? " active" : "")}>FAQs</a>
          </nav>
          <div className="header-cta">
            <a href="garage.html" className="btn btn-ghost btn-sm">Log in</a>
            <a href="garage.html" className="btn btn-primary btn-sm">Sign up free</a>
          </div>
        </div>
      </div>
    </header>
  ...
  return (
    <footer className="site-footer">
      <div className="container">
        <div className="grid">
          <div>
            <a href="index.html" className="brand" style={{marginBottom: 14}}>
              <span className="brand-mark">R</span>
              <span>RegScan</span>
            </a>
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="index.html#reminders">Reminders</a></li>
              <li><a href="garage.html">My Garage</a></li>
              <li><a href="index.html#upsell">Partner offers</a></li>
            </ul>
          </div>
          <div>
            <h5>Resources</h5>
            <ul>
              <li><a href="index.html#content">About MOT &amp; tax</a></li>
        ...
        <div className="legal">
          <span>© 2026 RegScan Ltd. Vehicle data from DVSA &amp; DVLA. Partner offers from third parties.</span>
...
// VRM input — uppercase, no spaces, max 8 chars (UK plate-ish)
function PlateInput({ value, onChange, onSubmit, autoFocus, size = "lg", placeholder = "AB12 CDE" }) {
...
function VehicleTypeSelect({ value, onChange, size = "lg" }) {
  return (
...
// Status badge logic — derive from vehicle data
function statusForMot(v) {
  if (!v) return { kind: "grey", text: "Unknown" };
  if (v.motStatus === "valid") {
    const days = window.RegScan.daysUntil(v.motExpiry);
...
Object.assign(window, {
  Icon, Header, Footer, PlateInput, VehicleTypeSelect,
  Toast, StatusBadge, statusForMot, statusForTax,
});
