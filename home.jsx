...
function HomePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setBusy(true);
    setError(null);
    // pretend an API call; navigate to results page
                ...
                <div className="row">
                  ...
                  <div>
                    <button type="submit" className="btn btn-primary" disabled={busy}>
                      {busy ? (
                        <><Icon name="search" size={16}/> Checking…</>
                      ) : (
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  <span><strong>Email reminders</strong> at 30, 14, 7 and 1 day before MOT and tax due.</span>
                </li>
                <li>
                  <span className="check"><Icon name="check" size={14}/></span>
                  <span><strong>SMS reminders</strong> for any UK number — coming soon.</span>
                </li>
                <li>
                  <span className="check"><Icon name="check" size={14}/></span>
                  <span><strong>Manage multiple vehicles</strong> from one garage — family cars, vans, motorbikes.</span>
                </li>
                <li>
                  <span className="check"><Icon name="check" size={14}/></span>
                  <span><strong>Unsubscribe anytime</strong> from a single click — no spam, no upsells in email.</span>
                </li>
              </ul>
              <div style={{display: "flex", gap: 10, marginTop: 22, flexWrap: "wrap"}}>
                <a href="garage.html" className="btn btn-primary btn-lg">
                  <Icon name="bell" size={18}/> Set up free reminders
                </a>
                <a href="garage.html" className="btn btn-secondary btn-lg">
                  See an example garage
                </a>
              </div>
            </div>
    ...
    <div className="hero-floats" aria-hidden="true">
      ...
      <div className="hf-advisory">
        <div className="hf-advisory__head">
          <span className="hf-advisory__chip">
            <Icon name="alert-triangle" size={13}/> Advisory
          </span>
